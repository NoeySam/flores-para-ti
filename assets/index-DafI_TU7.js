 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,W){var K=D.length;D.push(W);e:for(;0<K;){var ie=K-1>>>1,xe=D[ie];if(0<r(xe,W))D[ie]=W,D[K]=xe,K=ie;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var W=D[0],K=D.pop();if(K!==W){D[0]=K;e:for(var ie=0,xe=D.length,je=xe>>>1;ie<je;){var X=2*(ie+1)-1,re=D[X],de=X+1,se=D[de];if(0>r(re,K))de<xe&&0>r(se,re)?(D[ie]=se,D[de]=K,ie=de):(D[ie]=re,D[X]=K,ie=X);else if(de<xe&&0>r(se,K))D[ie]=se,D[de]=K,ie=de;else break e}}return W}function r(D,W){var K=D.sortIndex-W.sortIndex;return K!==0?K:D.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,h=null,d=3,p=!1,_=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(D){for(var W=n(u);W!==null;){if(W.callback===null)i(u);else if(W.startTime<=D)i(u),W.sortIndex=W.expirationTime,e(l,W);else break;W=n(u)}}function y(D){if(x=!1,v(D),!_)if(n(l)!==null)_=!0,G(R);else{var W=n(u);W!==null&&$(y,W.startTime-D)}}function R(D,W){_=!1,x&&(x=!1,c(b),b=-1),p=!0;var K=d;try{for(v(W),h=n(l);h!==null&&(!(h.expirationTime>W)||D&&!P());){var ie=h.callback;if(typeof ie=="function"){h.callback=null,d=h.priorityLevel;var xe=ie(h.expirationTime<=W);W=t.unstable_now(),typeof xe=="function"?h.callback=xe:h===n(l)&&i(l),v(W)}else i(l);h=n(l)}if(h!==null)var je=!0;else{var X=n(u);X!==null&&$(y,X.startTime-W),je=!1}return je}finally{h=null,d=K,p=!1}}var C=!1,A=null,b=-1,T=5,M=-1;function P(){return!(t.unstable_now()-M<T)}function k(){if(A!==null){var D=t.unstable_now();M=D;var W=!0;try{W=A(!0,D)}finally{W?z():(C=!1,A=null)}}else C=!1}var z;if(typeof g=="function")z=function(){g(k)};else if(typeof MessageChannel<"u"){var j=new MessageChannel,Y=j.port2;j.port1.onmessage=k,z=function(){Y.postMessage(null)}}else z=function(){m(k,0)};function G(D){A=D,C||(C=!0,z())}function $(D,W){b=m(function(){D(t.unstable_now())},W)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,G(R))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var W=3;break;default:W=d}var K=d;d=W;try{return D()}finally{d=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,W){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var K=d;d=D;try{return W()}finally{d=K}},t.unstable_scheduleCallback=function(D,W,K){var ie=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?ie+K:ie):K=ie,D){case 1:var xe=-1;break;case 2:xe=250;break;case 5:xe=1073741823;break;case 4:xe=1e4;break;default:xe=5e3}return xe=K+xe,D={id:f++,callback:W,priorityLevel:D,startTime:K,expirationTime:xe,sortIndex:-1},K>ie?(D.sortIndex=K,e(u,D),n(l)===null&&D===n(u)&&(x?(c(b),b=-1):x=!0,$(y,K-ie))):(D.sortIndex=xe,e(l,D),_||p||(_=!0,G(R))),D},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(D){var W=d;return function(){var K=d;d=W;try{return D.apply(this,arguments)}finally{d=K}}}})(am);om.exports=am;var xv=om.exports;/**
 * @license React
...
`)+`
`+c);const v=g+m+o,y=g+c+a,R=Fp(r,r.VERTEX_SHADER,v),C=Fp(r,r.FRAGMENT_SHADER,y);r.attachShader(x,R),r.attachShader(x,C),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function A(P){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(x).trim(),z=r.getShaderInfoLog(R).trim(),j=r.getShaderInfoLog(C).trim();let Y=!0,G=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(Y=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,R,C);else{const $=kp(r,R,"vertex"),D=kp(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`;function gw(t,e,n){let i=new L_;const r=new Ke,s=new Ke,o=new yt,a=new Gy({depthPacking:ty}),l=new Wy,u={},f=n.maxTextureSize,h={[Qi]:rn,[rn]:Qi,[li]:li},d=new Mi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:pw,fragmentShader:mw}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Dr;_.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new zn(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=a_;let c=this.type;this.render=function(C,A,b){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const T=t.getRenderTarget(),M=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),k=t.state;k.setBlending(qi),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const z=c!==si&&this.type===si,j=c===si&&this.type!==si;for(let Y=0,G=C.length;Y<G;Y++){const $=C[Y],D=$.shadow;if(D===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const W=D.getFrameExtents();if(r.multiply(W),s.copy(D.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/W.x),r.x=s.x*W.x,D.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/W.y),r.y=s.y*W.y,D.mapSize.y=s.y)),D.map===null||z===!0||j===!0){const ie=this.type!==si?{minFilter:Vn,magFilter:Vn}:{};D.map!==null&&D.map.dispose(),D.map=new yi(r.x,r.y,ie),D.map.texture.name=$.name+".shadowMap",D.camera.updateProjectionMatrix()}t.setRenderTarget(D.map),t.clear();const K=D.getViewportCount();for(let ie=0;ie<K;ie++){const xe=D.getViewport(ie);o.set(s.x*xe.x,s.y*xe.y,s.x*xe.z,s.y*xe.w),k.viewport(o),D.updateMatrices($,ie),i=D.getFrustum(),y(A,b,D.camera,$,this.type)}D.isPointLightShadow!==!0&&this.type===si&&g(D,b),D.needsUpdate=!1}c=this.type,m.needsUpdate=!1,t.setRenderTarget(T,M,P)};function g(C,A){const b=e.update(x);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new yi(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(A,null,b,d,x,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(A,null,b,p,x,null)}function v(C,A,b,T){let M=null;const P=b.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(P!==void 0)M=P;else if(M=b.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const k=M.uuid,z=A.uuid;let j=u[k];j===void 0&&(j={},u[k]=j);let Y=j[z];Y===void 0&&(Y=M.clone(),j[z]=Y,A.addEventListener("dispose",R)),M=Y}if(M.visible=A.visible,M.wireframe=A.wireframe,T===si?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:h[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,b.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=t.properties.get(M);k.light=b}return M}function y(C,A,b,T,M){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&M===si)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,C.matrixWorld);const z=e.update(C),j=C.material;if(Array.isArray(j)){const Y=z.groups;for(let G=0,$=Y.length;G<$;G++){const D=Y[G],W=j[D.materialIndex];if(W&&W.visible){const K=v(C,W,T,M);C.onBeforeShadow(t,C,A,b,z,K,D),t.renderBufferDirect(b,null,z,K,C,D),C.onAfterShadow(t,C,A,b,z,K,D)}}}else if(j.visible){const Y=v(C,j,T,M);C.onBeforeShadow(t,C,A,b,z,Y,null),t.renderBufferDirect(b,null,z,Y,C,null),C.onAfterShadow(t,C,A,b,z,Y,null)}}const k=C.children;for(let z=0,j=k.length;z<j;z++)y(k[z],A,b,T,M)}function R(C){C.target.removeEventListener("dispose",R);for(const b in u){const T=u[b],M=C.target.uuid;M in T&&(T[M].dispose(),delete T[M])}}}const _w={[Hc]:Vc,[Gc]:jc,[Wc]:Yc,[As]:Xc,[Vc]:Hc,[jc]:Gc,[Yc]:Wc,[Xc]:As};function vw(t,e){function n(){let U=!1;const ae=new yt;let V=null;const Q=new yt(0,0,0,0);return{setMask:function(fe){V!==fe&&!U&&(t.colorMask(fe,fe,fe,fe),V=fe)},setLocked:function(fe){U=fe},setClear:function(fe,ce,De,mt,Ot){Ot===!0&&(fe*=mt,ce*=mt,De*=mt),ae.set(fe,ce,De,mt),Q.equals(ae)===!1&&(t.clearColor(fe,ce,De,mt),Q.copy(ae))},reset:function(){U=!1,V=null,Q.set(-1,0,0,0)}}}function i(){let U=!1,ae=!1,V=null,Q=null,fe=null;return{setReversed:function(ce){if(ae!==ce){const De=e.get("EXT_clip_control");ae?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT);const mt=fe;fe=null,this.setClear(mt)}ae=ce},getReversed:function(){return ae},setTest:function(ce){ce?se(t.DEPTH_TEST):Ae(t.DEPTH_TEST)},setMask:function(ce){V!==ce&&!U&&(t.depthMask(ce),V=ce)},setFunc:function(ce){if(ae&&(ce=_w[ce]),Q!==ce){switch(ce){case Hc:t.depthFunc(t.NEVER);break;case Vc:t.depthFunc(t.ALWAYS);break;case Gc:t.depthFunc(t.LESS);break;case As:t.depthFunc(t.LEQUAL);break;case Wc:t.depthFunc(t.EQUAL);break;case Xc:t.depthFunc(t.GEQUAL);break;case jc:t.depthFunc(t.GREATER);break;case Yc:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}Q=ce}},setLocked:function(ce){U=ce},setClear:function(ce){fe!==ce&&(ae&&(ce=1-ce),t.clearDepth(ce),fe=ce)},reset:function(){U=!1,V=null,Q=null,fe=null,ae=!1}}}function r(){let U=!1,ae=null,V=null,Q=null,fe=null,ce=null,De=null,mt=null,Ot=null;return{setTest:function(Je){U||(Je?se(t.STENCIL_TEST):Ae(t.STENCIL_TEST))},setMask:function(Je){ae!==Je&&!U&&(t.stencilMask(Je),ae=Je)},setFunc:function(Je,Cn,Qn){(V!==Je||Q!==Cn||fe!==Qn)&&(t.stencilFunc(Je,Cn,Qn),V=Je,Q=Cn,fe=Qn)},setOp:function(Je,Cn,Qn){(ce!==Je||De!==Cn||mt!==Qn)&&(t.stencilOp(Je,Cn,Qn),ce=Je,De=Cn,mt=Qn)},setLocked:function(Je){U=Je},setClear:function(Je){Ot!==Je&&(t.clearStencil(Je),Ot=Je)},reset:function(){U=!1,ae=null,V=null,Q=null,fe=null,ce=null,De=null,mt=null,Ot=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,u=new WeakMap;let f={},h={},d=new WeakMap,p=[],_=null,x=!1,m=null,c=null,g=null,v=null,y=null,R=null,C=null,A=new et(0,0,0),b=0,T=!1,M=null,P=null,k=null,z=null,j=null;const Y=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,$=0;const D=t.getParameter(t.VERSION);D.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(D)[1]),G=$>=1):D.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(D)[1]),G=$>=2);let W=null,K={};const ie=t.getParameter(t.SCISSOR_BOX),xe=t.getParameter(t.VIEWPORT),je=new yt().fromArray(ie),X=new yt().fromArray(xe);function re(U,ae,V,Q){const fe=new Uint8Array(4),ce=t.createTexture();t.bindTexture(U,ce),t.texParameteri(U,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(U,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let De=0;De<V;De++)U===t.TEXTURE_3D||U===t.TEXTURE_2D_ARRAY?t.texImage3D(ae,0,t.RGBA,1,1,Q,0,t.RGBA,t.UNSIGNED_BYTE,fe):t.texImage2D(ae+De,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,fe);return ce}const de={};de[t.TEXTURE_2D]=re(t.TEXTURE_2D,t.TEXTURE_2D,1),de[t.TEXTURE_CUBE_MAP]=re(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[t.TEXTURE_2D_ARRAY]=re(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),de[t.TEXTURE_3D]=re(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(t.DEPTH_TEST),o.setFunc(As),Be(!1),He($h),se(t.CULL_FACE),L(qi);function se(U){f[U]!==!0&&(t.enable(U),f[U]=!0)}function Ae(U){f[U]!==!1&&(t.disable(U),f[U]=!1)}function $e(U,ae){return h[U]!==ae?(t.bindFramebuffer(U,ae),h[U]=ae,U===t.DRAW_FRAMEBUFFER&&(h[t.FRAMEBUFFER]=ae),U===t.FRAMEBUFFER&&(h[t.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ce(U,ae){let V=p,Q=!1;if(U){V=d.get(ae),V===void 0&&(V=[],d.set(ae,V));const fe=U.textures;if(V.length!==fe.length||V[0]!==t.COLOR_ATTACHMENT0){for(let ce=0,De=fe.length;ce<De;ce++)V[ce]=t.COLOR_ATTACHMENT0+ce;V.length=fe.length,Q=!0}}else V[0]!==t.BACK&&(V[0]=t.BACK,Q=!0);Q&&t.drawBuffers(V)}function vt(U){return _!==U?(t.useProgram(U),_=U,!0):!1}const ft={[pr]:t.FUNC_ADD,[Cx]:t.FUNC_SUBTRACT,[Rx]:t.FUNC_REVERSE_SUBTRACT};ft[bx]=t.MIN,ft[Px]=t.MAX;const ze={[Lx]:t.ZERO,[Dx]:t.ONE,[Ux]:t.SRC_COLOR,[zc]:t.SRC_ALPHA,[zx]:t.SRC_ALPHA_SATURATE,[Ox]:t.DST_COLOR,[Nx]:t.DST_ALPHA,[Ix]:t.ONE_MINUS_SRC_COLOR,[Bc]:t.ONE_MINUS_SRC_ALPHA,[kx]:t.ONE_MINUS_DST_COLOR,[Fx]:t.ONE_MINUS_DST_ALPHA,[Bx]:t.CONSTANT_COLOR,[Hx]:t.ONE_MINUS_CONSTANT_COLOR,[Vx]:t.CONSTANT_ALPHA,[Gx]:t.ONE_MINUS_CONSTANT_ALPHA};function L(U,ae,V,Q,fe,ce,De,mt,Ot,Je){if(U===qi){x===!0&&(Ae(t.BLEND),x=!1);return}if(x===!1&&(se(t.BLEND),x=!0),U!==Ax){if(U!==m||Je!==T){if((c!==pr||y!==pr)&&(t.blendEquation(t.FUNC_ADD),c=pr,y=pr),Je)switch(U){case ms:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Kh:t.blendFunc(t.ONE,t.ONE);break;case Zh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Qh:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case ms:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Kh:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Zh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Qh:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}g=null,v=null,R=null,C=null,A.set(0,0,0),b=0,m=U,T=Je}return}fe=fe||ae,ce=ce||V,De=De||Q,(ae!==c||fe!==y)&&(t.blendEquationSeparate(ft[ae],ft[fe]),c=ae,y=fe),(V!==g||Q!==v||ce!==R||De!==C)&&(t.blendFuncSeparate(ze[V],ze[Q],ze[ce],ze[De]),g=V,v=Q,R=ce,C=De),(mt.equals(A)===!1||Ot!==b)&&(t.blendColor(mt.r,mt.g,mt.b,Ot),A.copy(mt),b=Ot),m=U,T=!1}function gn(U,ae){U.side===li?Ae(t.CULL_FACE):se(t.CULL_FACE);let V=U.side===rn;ae&&(V=!V),Be(V),U.blending===ms&&U.transparent===!1?L(qi):L(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const Q=U.stencilWrite;a.setTest(Q),Q&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),st(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?se(t.SAMPLE_ALPHA_TO_COVERAGE):Ae(t.SAMPLE_ALPHA_TO_COVERAGE)}function Be(U){M!==U&&(U?t.frontFace(t.CW):t.frontFace(t.CCW),M=U)}function He(U){U!==Ex?(se(t.CULL_FACE),U!==P&&(U===$h?t.cullFace(t.BACK):U===Tx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ae(t.CULL_FACE),P=U}function Me(U){U!==k&&(G&&t.lineWidth(U),k=U)}function st(U,ae,V){U?(se(t.POLYGON_OFFSET_FILL),(z!==ae||j!==V)&&(t.polygonOffset(ae,V),z=ae,j=V)):Ae(t.POLYGON_OFFSET_FILL)}function Se(U){U?se(t.SCISSOR_TEST):Ae(t.SCISSOR_TEST)}function w(U){U===void 0&&(U=t.TEXTURE0+Y-1),W!==U&&(t.activeTexture(U),W=U)}function S(U,ae,V){V===void 0&&(W===null?V=t.TEXTURE0+Y-1:V=W);let Q=K[V];Q===void 0&&(Q={type:void 0,texture:void 0},K[V]=Q),(Q.type!==U||Q.texture!==ae)&&(W!==V&&(t.activeTexture(V),W=V),t.bindTexture(U,ae||de[U]),Q.type=U,Q.texture=ae)}function F(){const U=K[W];U!==void 0&&U.type!==void 0&&(t.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Z(){try{t.compressedTexImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function J(){try{t.compressedTexImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function q(){try{t.texSubImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ye(){try{t.texSubImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ue(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function me(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ge(){try{t.texStorage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ne(){try{t.texStorage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ge(){try{t.texImage2D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function we(){try{t.texImage3D.apply(t,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function be(U){je.equals(U)===!1&&(t.scissor(U.x,U.y,U.z,U.w),je.copy(U))}function _e(U){X.equals(U)===!1&&(t.viewport(U.x,U.y,U.z,U.w),X.copy(U))}function Ve(U,ae){let V=u.get(ae);V===void 0&&(V=new WeakMap,u.set(ae,V));let Q=V.get(U);Q===void 0&&(Q=t.getUniformBlockIndex(ae,U.name),V.set(U,Q))}function Ne(U,ae){const Q=u.get(ae).get(U);l.get(ae)!==Q&&(t.uniformBlockBinding(ae,Q,U.__bindingPointIndex),l.set(ae,Q))}function it(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),f={},W=null,K={},h={},d=new WeakMap,p=[],_=null,x=!1,m=null,c=null,g=null,v=null,y=null,R=null,C=null,A=new et(0,0,0),b=0,T=!1,M=null,P=null,k=null,z=null,j=null,je.set(0,0,t.canvas.width,t.canvas.height),X.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:Ae,bindFramebuffer:$e,drawBuffers:Ce,useProgram:vt,setBlending:L,setMaterial:gn,setFlipSided:Be,setCullFace:He,setLineWidth:Me,setPolygonOffset:st,setScissorTest:Se,activeTexture:w,bindTexture:S,unbindTexture:F,compressedTexImage2D:Z,compressedTexImage3D:J,texImage2D:ge,texImage3D:we,updateUBOMapping:Ve,uniformBlockBinding:Ne,texStorage2D:Ge,texStorage3D:ne,texSubImage2D:q,texSubImage3D:ye,compressedTexSubImage2D:ue,compressedTexSubImage3D:me,scissor:be,viewport:_e,reset:it}}function xw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new Ke,f=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(w,S){return p?new OffscreenCanvas(w,S):Ml("canvas")}function x(w,S,F){let Z=1;const J=Se(w);if((J.width>F||J.height>F)&&(Z=F/Math.max(J.width,J.height)),Z<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const q=Math.floor(Z*J.width),ye=Math.floor(Z*J.height);h===void 0&&(h=_(q,ye));const ue=S?_(q,ye):h;return ue.width=q,ue.height=ye,ue.getContext("2d").drawImage(w,0,0,q,ye),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+q+"x"+ye+")."),ue}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),w;return w}function m(w){return w.generateMipmaps}function c(w){t.generateMipmap(w)}function g(w){return w.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?t.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function v(w,S,F,Z,J=!1){if(w!==null){if(t[w]!==void 0)return t[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=S;if(S===t.RED&&(F===t.FLOAT&&(q=t.R32F),F===t.HALF_FLOAT&&(q=t.R16F),F===t.UNSIGNED_BYTE&&(q=t.R8)),S===t.RED_INTEGER&&(F===t.UNSIGNED_BYTE&&(q=t.R8UI),F===t.UNSIGNED_SHORT&&(q=t.R16UI),F===t.UNSIGNED_INT&&(q=t.R32UI),F===t.BYTE&&(q=t.R8I),F===t.SHORT&&(q=t.R16I),F===t.INT&&(q=t.R32I)),S===t.RG&&(F===t.FLOAT&&(q=t.RG32F),F===t.HALF_FLOAT&&(q=t.RG16F),F===t.UNSIGNED_BYTE&&(q=t.RG8)),S===t.RG_INTEGER&&(F===t.UNSIGNED_BYTE&&(q=t.RG8UI),F===t.UNSIGNED_SHORT&&(q=t.RG16UI),F===t.UNSIGNED_INT&&(q=t.RG32UI),F===t.BYTE&&(q=t.RG8I),F===t.SHORT&&(q=t.RG16I),F===t.INT&&(q=t.RG32I)),S===t.RGB_INTEGER&&(F===t.UNSIGNED_BYTE&&(q=t.RGB8UI),F===t.UNSIGNED_SHORT&&(q=t.RGB16UI),F===t.UNSIGNED_INT&&(q=t.RGB32UI),F===t.BYTE&&(q=t.RGB8I),F===t.SHORT&&(q=t.RGB16I),F===t.INT&&(q=t.RGB32I)),S===t.RGBA_INTEGER&&(F===t.UNSIGNED_BYTE&&(q=t.RGBA8UI),F===t.UNSIGNED_SHORT&&(q=t.RGBA16UI),F===t.UNSIGNED_INT&&(q=t.RGBA32UI),F===t.BYTE&&(q=t.RGBA8I),F===t.SHORT&&(q=t.RGBA16I),F===t.INT&&(q=t.RGBA32I)),S===t.RGB&&F===t.UNSIGNED_INT_5_9_9_9_REV&&(q=t.RGB9_E5),S===t.RGBA){const ye=J?yl:qe.getTransfer(Z);F===t.FLOAT&&(q=t.RGBA32F),F===t.HALF_FLOAT&&(q=t.RGBA16F),F===t.UNSIGNED_BYTE&&(q=ye===nt?t.SRGB8_ALPHA8:t.RGBA8),F===t.UNSIGNED_SHORT_4_4_4_4&&(q=t.RGBA4),F===t.UNSIGNED_SHORT_5_5_5_1&&(q=t.RGB5_A1)}return(q===t.R16F||q===t.R32F||q===t.RG16F||q===t.RG32F||q===t.RGBA16F||q===t.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function y(w,S){let F;return w?S===null||S===br||S===bs?F=t.DEPTH24_STENCIL8:S===fi?F=t.DEPTH32F_STENCIL8:S===Uo&&(F=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===br||S===bs?F=t.DEPTH_COMPONENT24:S===fi?F=t.DEPTH_COMPONENT32F:S===Uo&&(F=t.DEPTH_COMPONENT16),F}function R(w,S){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==Vn&&w.minFilter!==qn?Math.log2(Math.max(S.width,S.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?S.mipmaps.length:1}function C(w){const S=w.target;S.removeEventListener("dispose",C),b(S),S.isVideoTexture&&f.delete(S)}function A(w){const S=w.target;S.removeEventListener("dispose",A),M(S)}function b(w){const S=i.get(w);if(S.__webglInit===void 0)return;const F=w.source,Z=d.get(F);if(Z){const J=Z[S.__cacheKey];J.usedTimes--,J.usedTimes===0&&T(w),Object.keys(Z).length===0&&d.delete(F)}i.remove(w)}function T(w){const S=i.get(w);t.deleteTexture(S.__webglTexture);const F=w.source,Z=d.get(F);delete Z[S.__cacheKey],o.memory.textures--}function M(w){const S=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(S.__webglFramebuffer[Z]))for(let J=0;J<S.__webglFramebuffer[Z].length;J++)t.deleteFramebuffer(S.__webglFramebuffer[Z][J]);else t.deleteFramebuffer(S.__webglFramebuffer[Z]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[Z])}else{if(Array.isArray(S.__webglFramebuffer))for(let Z=0;Z<S.__webglFramebuffer.length;Z++)t.deleteFramebuffer(S.__webglFramebuffer[Z]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Z=0;Z<S.__webglColorRenderbuffer.length;Z++)S.__webglColorRenderbuffer[Z]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[Z]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const F=w.textures;for(let Z=0,J=F.length;Z<J;Z++){const q=i.get(F[Z]);q.__webglTexture&&(t.deleteTexture(q.__webglTexture),o.memory.textures--),i.remove(F[Z])}i.remove(w)}let P=0;function k(){P=0}function z(){const w=P;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),P+=1,w}function j(w){const S=[];return S.push(w.wrapS),S.push(w.wrapT),S.push(w.wrapR||0),S.push(w.magFilter),S.push(w.minFilter),S.push(w.anisotropy),S.push(w.internalFormat),S.push(w.format),S.push(w.type),S.push(w.generateMipmaps),S.push(w.premultiplyAlpha),S.push(w.flipY),S.push(w.unpackAlignment),S.push(w.colorSpace),S.join()}function Y(w,S){const F=i.get(w);if(w.isVideoTexture&&Me(w),w.isRenderTargetTexture===!1&&w.version>0&&F.__version!==w.version){const Z=w.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(F,w,S);return}}n.bindTexture(t.TEXTURE_2D,F.__webglTexture,t.TEXTURE0+S)}function G(w,S){const F=i.get(w);if(w.version>0&&F.__version!==w.version){X(F,w,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,F.__webglTexture,t.TEXTURE0+S)}function $(w,S){const F=i.get(w);if(w.version>0&&F.__version!==w.version){X(F,w,S);return}n.bindTexture(t.TEXTURE_3D,F.__webglTexture,t.TEXTURE0+S)}function D(w,S){const F=i.get(w);if(w.version>0&&F.__version!==w.version){re(F,w,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,F.__webglTexture,t.TEXTURE0+S)}const W={[Kc]:t.REPEAT,[xr]:t.CLAMP_TO_EDGE,[Zc]:t.MIRRORED_REPEAT},K={[Vn]:t.NEAREST,[Jx]:t.NEAREST_MIPMAP_NEAREST,[ca]:t.NEAREST_MIPMAP_LINEAR,[qn]:t.LINEAR,[gu]:t.LINEAR_MIPMAP_NEAREST,[yr]:t.LINEAR_MIPMAP_LINEAR},ie={[ry]:t.NEVER,[cy]:t.ALWAYS,[sy]:t.LESS,[y_]:t.LEQUAL,[oy]:t.EQUAL,[uy]:t.GEQUAL,[ay]:t.GREATER,[ly]:t.NOTEQUAL};function xe(w,S){if(S.type===fi&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===qn||S.magFilter===gu||S.magFilter===ca||S.magFilter===yr||S.minFilter===qn||S.minFilter===gu||S.minFilter===ca||S.minFilter===yr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(w,t.TEXTURE_WRAP_S,W[S.wrapS]),t.texParameteri(w,t.TEXTURE_WRAP_T,W[S.wrapT]),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,W[S.wrapR]),t.texParameteri(w,t.TEXTURE_MAG_FILTER,K[S.magFilter]),t.texParameteri(w,t.TEXTURE_MIN_FILTER,K[S.minFilter]),S.compareFunction&&(t.texParameteri(w,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(w,t.TEXTURE_COMPARE_FUNC,ie[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Vn||S.minFilter!==ca&&S.minFilter!==yr||S.type===fi&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");t.texParameterf(w,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function je(w,S){let F=!1;w.__webglInit===void 0&&(w.__webglInit=!0,S.addEventListener("dispose",C));const Z=S.source;let J=d.get(Z);J===void 0&&(J={},d.set(Z,J));const q=j(S);if(q!==w.__cacheKey){J[q]===void 0&&(J[q]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,F=!0),J[q].usedTimes++;const ye=J[w.__cacheKey];ye!==void 0&&(J[w.__cacheKey].usedTimes--,ye.usedTimes===0&&T(S)),w.__cacheKey=q,w.__webglTexture=J[q].texture}return F}function X(w,S,F){let Z=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Z=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Z=t.TEXTURE_3D);const J=je(w,S),q=S.source;n.bindTexture(Z,w.__webglTexture,t.TEXTURE0+F);const ye=i.get(q);if(q.version!==ye.__version||J===!0){n.activeTexture(t.TEXTURE0+F);const ue=qe.getPrimaries(qe.workingColorSpace),me=S.colorSpace===Oi?null:qe.getPrimaries(S.colorSpace),Ge=S.colorSpace===Oi||ue===me?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ge);let ne=x(S.image,!1,r.maxTextureSize);ne=st(S,ne);const ge=s.convert(S.format,S.colorSpace),we=s.convert(S.type);let be=v(S.internalFormat,ge,we,S.colorSpace,S.isVideoTexture);xe(Z,S);let _e;const Ve=S.mipmaps,Ne=S.isVideoTexture!==!0,it=ye.__version===void 0||J===!0,U=q.dataReady,ae=R(S,ne);if(S.isDepthTexture)be=y(S.format===Ps,S.type),it&&(Ne?n.texStorage2D(t.TEXTURE_2D,1,be,ne.width,ne.height):n.texImage2D(t.TEXTURE_2D,0,be,ne.width,ne.height,0,ge,we,null));else if(S.isDataTexture)if(Ve.length>0){Ne&&it&&n.texStorage2D(t.TEXTURE_2D,ae,be,Ve[0].width,Ve[0].height);for(let V=0,Q=Ve.length;V<Q;V++)_e=Ve[V],Ne?U&&n.texSubImage2D(t.TEXTURE_2D,V,0,0,_e.width,_e.height,ge,we,_e.data):n.texImage2D(t.TEXTURE_2D,V,be,_e.width,_e.height,0,ge,we,_e.data);S.generateMipmaps=!1}else Ne?(it&&n.texStorage2D(t.TEXTURE_2D,ae,be,ne.width,ne.height),U&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ne.width,ne.height,ge,we,ne.data)):n.texImage2D(t.TEXTURE_2D,0,be,ne.width,ne.height,0,ge,we,ne.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ne&&it&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,be,Ve[0].width,Ve[0].height,ne.depth);for(let V=0,Q=Ve.length;V<Q;V++)if(_e=Ve[V],S.format!==kn)if(ge!==null)if(Ne){if(U)if(S.layerUpdates.size>0){const fe=Sp(_e.width,_e.height,S.format,S.type);for(const ce of S.layerUpdates){const De=_e.data.subarray(ce*fe/_e.data.BYTES_PER_ELEMENT,(ce+1)*fe/_e.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,V,0,0,ce,_e.width,_e.height,1,ge,De)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,V,0,0,0,_e.width,_e.height,ne.depth,ge,_e.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,V,be,_e.width,_e.height,ne.depth,0,_e.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?U&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,V,0,0,0,_e.width,_e.height,ne.depth,ge,we,_e.data):n.texImage3D(t.TEXTURE_2D_ARRAY,V,be,_e.width,_e.height,ne.depth,0,ge,we,_e.data)}else{Ne&&it&&n.texStorage2D(t.TEXTURE_2D,ae,be,Ve[0].width,Ve[0].height);for(let V=0,Q=Ve.length;V<Q;V++)_e=Ve[V],S.format!==kn?ge!==null?Ne?U&&n.compressedTexSubImage2D(t.TEXTURE_2D,V,0,0,_e.width,_e.height,ge,_e.data):n.compressedTexImage2D(t.TEXTURE_2D,V,be,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?U&&n.texSubImage2D(t.TEXTURE_2D,V,0,0,_e.width,_e.height,ge,we,_e.data):n.texImage2D(t.TEXTURE_2D,V,be,_e.width,_e.height,0,ge,we,_e.data)}else if(S.isDataArrayTexture)if(Ne){if(it&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,be,ne.width,ne.height,ne.depth),U)if(S.layerUpdates.size>0){const V=Sp(ne.width,ne.height,S.format,S.type);for(const Q of S.layerUpdates){const fe=ne.data.subarray(Q*V/ne.data.BYTES_PER_ELEMENT,(Q+1)*V/ne.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,Q,ne.width,ne.height,1,ge,we,fe)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,ge,we,ne.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,be,ne.width,ne.height,ne.depth,0,ge,we,ne.data);else if(S.isData3DTexture)Ne?(it&&n.texStorage3D(t.TEXTURE_3D,ae,be,ne.width,ne.height,ne.depth),U&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,ge,we,ne.data)):n.texImage3D(t.TEXTURE_3D,0,be,ne.width,ne.height,ne.depth,0,ge,we,ne.data);else if(S.isFramebufferTexture){if(it)if(Ne)n.texStorage2D(t.TEXTURE_2D,ae,be,ne.width,ne.height);else{let V=ne.width,Q=ne.height;for(let fe=0;fe<ae;fe++)n.texImage2D(t.TEXTURE_2D,fe,be,V,Q,0,ge,we,null),V>>=1,Q>>=1}}else if(Ve.length>0){if(Ne&&it){const V=Se(Ve[0]);n.texStorage2D(t.TEXTURE_2D,ae,be,V.width,V.height)}for(let V=0,Q=Ve.length;V<Q;V++)_e=Ve[V],Ne?U&&n.texSubImage2D(t.TEXTURE_2D,V,0,0,ge,we,_e):n.texImage2D(t.TEXTURE_2D,V,be,ge,we,_e);S.generateMipmaps=!1}else if(Ne){if(it){const V=Se(ne);n.texStorage2D(t.TEXTURE_2D,ae,be,V.width,V.height)}U&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ge,we,ne)}else n.texImage2D(t.TEXTURE_2D,0,be,ge,we,ne);m(S)&&c(Z),ye.__version=q.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function re(w,S,F){if(S.image.length!==6)return;const Z=je(w,S),J=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,w.__webglTexture,t.TEXTURE0+F);const q=i.get(J);if(J.version!==q.__version||Z===!0){n.activeTexture(t.TEXTURE0+F);const ye=qe.getPrimaries(qe.workingColorSpace),ue=S.colorSpace===Oi?null:qe.getPrimaries(S.colorSpace),me=S.colorSpace===Oi||ye===ue?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,me);const Ge=S.isCompressedTexture||S.image[0].isCompressedTexture,ne=S.image[0]&&S.image[0].isDataTexture,ge=[];for(let Q=0;Q<6;Q++)!Ge&&!ne?ge[Q]=x(S.image[Q],!0,r.maxCubemapSize):ge[Q]=ne?S.image[Q].image:S.image[Q],ge[Q]=st(S,ge[Q]);const we=ge[0],be=s.convert(S.format,S.colorSpace),_e=s.convert(S.type),Ve=v(S.internalFormat,be,_e,S.colorSpace),Ne=S.isVideoTexture!==!0,it=q.__version===void 0||Z===!0,U=J.dataReady;let ae=R(S,we);xe(t.TEXTURE_CUBE_MAP,S);let V;if(Ge){Ne&&it&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ae,Ve,we.width,we.height);for(let Q=0;Q<6;Q++){V=ge[Q].mipmaps;for(let fe=0;fe<V.length;fe++){const ce=V[fe];S.format!==kn?be!==null?Ne?U&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,0,0,ce.width,ce.height,be,ce.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,Ve,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?U&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,0,0,ce.width,ce.height,be,_e,ce.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe,Ve,ce.width,ce.height,0,be,_e,ce.data)}}}else{if(V=S.mipmaps,Ne&&it){V.length>0&&ae++;const Q=Se(ge[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ae,Ve,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ne){Ne?U&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ge[Q].width,ge[Q].height,be,_e,ge[Q].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ve,ge[Q].width,ge[Q].height,0,be,_e,ge[Q].data);for(let fe=0;fe<V.length;fe++){const De=V[fe].image[Q].image;Ne?U&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,0,0,De.width,De.height,be,_e,De.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,Ve,De.width,De.height,0,be,_e,De.data)}}else{Ne?U&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,be,_e,ge[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ve,be,_e,ge[Q]);for(let fe=0;fe<V.length;fe++){const ce=V[fe];Ne?U&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,0,0,be,_e,ce.image[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,fe+1,Ve,be,_e,ce.image[Q])}}}m(S)&&c(t.TEXTURE_CUBE_MAP),q.__version=J.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function de(w,S,F,Z,J,q){const ye=s.convert(F.format,F.colorSpace),ue=s.convert(F.type),me=v(F.internalFormat,ye,ue,F.colorSpace),Ge=i.get(S),ne=i.get(F);if(ne.__renderTarget=S,!Ge.__hasExternalTextures){const ge=Math.max(1,S.width>>q),we=Math.max(1,S.height>>q);J===t.TEXTURE_3D||J===t.TEXTURE_2D_ARRAY?n.texImage3D(J,q,me,ge,we,S.depth,0,ye,ue,null):n.texImage2D(J,q,me,ge,we,0,ye,ue,null)}n.bindFramebuffer(t.FRAMEBUFFER,w),He(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,J,ne.__webglTexture,0,Be(S)):(J===t.TEXTURE_2D||J>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Z,J,ne.__webglTexture,q),n.bindFramebuffer(t.FRAMEBUFFER,null)}function se(w,S,F){if(t.bindRenderbuffer(t.RENDERBUFFER,w),S.depthBuffer){const Z=S.depthTexture,J=Z&&Z.isDepthTexture?Z.type:null,q=y(S.stencilBuffer,J),ye=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=Be(S);He(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ue,q,S.width,S.height):F?t.renderbufferStorageMultisample(t.RENDERBUFFER,ue,q,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,q,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,ye,t.RENDERBUFFER,w)}else{const Z=S.textures;for(let J=0;J<Z.length;J++){const q=Z[J],ye=s.convert(q.format,q.colorSpace),ue=s.convert(q.type),me=v(q.internalFormat,ye,ue,q.colorSpace),Ge=Be(S);F&&He(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ge,me,S.width,S.height):He(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ge,me,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,me,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ae(w,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,w),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=i.get(S.depthTexture);Z.__renderTarget=S,(!Z.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),Y(S.depthTexture,0);const J=Z.__webglTexture,q=Be(S);if(S.depthTexture.format===gs)He(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,J,0,q):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,J,0);else if(S.depthTexture.format===Ps)He(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,J,0,q):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function $e(w){const S=i.get(w),F=w.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==w.depthTexture){const Z=w.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Z){const J=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Z.removeEventListener("dispose",J)};Z.addEventListener("dispose",J),S.__depthDisposeCallback=J}S.__boundDepthTexture=Z}if(w.depthTexture&&!S.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Ae(S.__webglFramebuffer,w)}else if(F){S.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[Z]),S.__webglDepthbuffer[Z]===void 0)S.__webglDepthbuffer[Z]=t.createRenderbuffer(),se(S.__webglDepthbuffer[Z],w,!1);else{const J=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,q=S.__webglDepthbuffer[Z];t.bindRenderbuffer(t.RENDERBUFFER,q),t.framebufferRenderbuffer(t.FRAMEBUFFER,J,t.RENDERBUFFER,q)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),se(S.__webglDepthbuffer,w,!1);else{const Z=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,J=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,J),t.framebufferRenderbuffer(t.FRAMEBUFFER,Z,t.RENDERBUFFER,J)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ce(w,S,F){const Z=i.get(w);S!==void 0&&de(Z.__webglFramebuffer,w,w.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),F!==void 0&&$e(w)}function vt(w){const S=w.texture,F=i.get(w),Z=i.get(S);w.addEventListener("dispose",A);const J=w.textures,q=w.isWebGLCubeRenderTarget===!0,ye=J.length>1;if(ye||(Z.__webglTexture===void 0&&(Z.__webglTexture=t.createTexture()),Z.__version=S.version,o.memory.textures++),q){F.__webglFramebuffer=[];for(let ue=0;ue<6;ue++)if(S.mipmaps&&S.mipmaps.length>0){F.__webglFramebuffer[ue]=[];for(let me=0;me<S.mipmaps.length;me++)F.__webglFramebuffer[ue][me]=t.createFramebuffer()}else F.__webglFramebuffer[ue]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){F.__webglFramebuffer=[];for(let ue=0;ue<S.mipmaps.length;ue++)F.__webglFramebuffer[ue]=t.createFramebuffer()}else F.__webglFramebuffer=t.createFramebuffer();if(ye)for(let ue=0,me=J.length;ue<me;ue++){const Ge=i.get(J[ue]);Ge.__webglTexture===void 0&&(Ge.__webglTexture=t.createTexture(),o.memory.textures++)}if(w.samples>0&&He(w)===!1){F.__webglMultisampledFramebuffer=t.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ue=0;ue<J.length;ue++){const me=J[ue];F.__webglColorRenderbuffer[ue]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,F.__webglColorRenderbuffer[ue]);const Ge=s.convert(me.format,me.colorSpace),ne=s.convert(me.type),ge=v(me.internalFormat,Ge,ne,me.colorSpace,w.isXRRenderTarget===!0),we=Be(w);t.renderbufferStorageMultisample(t.RENDERBUFFER,we,ge,w.width,w.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ue,t.RENDERBUFFER,F.__webglColorRenderbuffer[ue])}t.bindRenderbuffer(t.RENDERBUFFER,null),w.depthBuffer&&(F.__webglDepthRenderbuffer=t.createRenderbuffer(),se(F.__webglDepthRenderbuffer,w,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(q){n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),xe(t.TEXTURE_CUBE_MAP,S);for(let ue=0;ue<6;ue++)if(S.mipmaps&&S.mipmaps.length>0)for(let me=0;me<S.mipmaps.length;me++)de(F.__webglFramebuffer[ue][me],w,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,me);else de(F.__webglFramebuffer[ue],w,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0);m(S)&&c(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ye){for(let ue=0,me=J.length;ue<me;ue++){const Ge=J[ue],ne=i.get(Ge);n.bindTexture(t.TEXTURE_2D,ne.__webglTexture),xe(t.TEXTURE_2D,Ge),de(F.__webglFramebuffer,w,Ge,t.COLOR_ATTACHMENT0+ue,t.TEXTURE_2D,0),m(Ge)&&c(t.TEXTURE_2D)}n.unbindTexture()}else{let ue=t.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ue=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ue,Z.__webglTexture),xe(ue,S),S.mipmaps&&S.mipmaps.length>0)for(let me=0;me<S.mipmaps.length;me++)de(F.__webglFramebuffer[me],w,S,t.COLOR_ATTACHMENT0,ue,me);else de(F.__webglFramebuffer,w,S,t.COLOR_ATTACHMENT0,ue,0);m(S)&&c(ue),n.unbindTexture()}w.depthBuffer&&$e(w)}function ft(w){const S=w.textures;for(let F=0,Z=S.length;F<Z;F++){const J=S[F];if(m(J)){const q=g(w),ye=i.get(J).__webglTexture;n.bindTexture(q,ye),c(q),n.unbindTexture()}}}const ze=[],L=[];function gn(w){if(w.samples>0){if(He(w)===!1){const S=w.textures,F=w.width,Z=w.height;let J=t.COLOR_BUFFER_BIT;const q=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ye=i.get(w),ue=S.length>1;if(ue)for(let me=0;me<S.length;me++)n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let me=0;me<S.length;me++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(J|=t.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(J|=t.STENCIL_BUFFER_BIT)),ue){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ye.__webglColorRenderbuffer[me]);const Ge=i.get(S[me]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ge,0)}t.blitFramebuffer(0,0,F,Z,0,0,F,Z,J,t.NEAREST),l===!0&&(ze.length=0,L.length=0,ze.push(t.COLOR_ATTACHMENT0+me),w.depthBuffer&&w.resolveDepthBuffer===!1&&(ze.push(q),L.push(q),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,L)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ze))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ue)for(let me=0;me<S.length;me++){n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,ye.__webglColorRenderbuffer[me]);const Ge=i.get(S[me]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ye.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,Ge,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const S=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function Be(w){return Math.min(r.maxSamples,w.samples)}function He(w){const S=i.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Me(w){const S=o.render.frame;f.get(w)!==S&&(f.set(w,S),w.update())}function st(w,S){const F=w.colorSpace,Z=w.format,J=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||F!==Ls&&F!==Oi&&(qe.getTransfer(F)===nt?(Z!==kn||J!==xi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),S}function Se(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(u.width=w.naturalWidth||w.width,u.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(u.width=w.displayWidth,u.height=w.displayHeight):(u.width=w.width,u.height=w.height),u}this.allocateTextureUnit=z,this.resetTextureUnits=k,this.setTexture2D=Y,this.setTexture2DArray=G,this.setTexture3D=$,this.setTextureCube=D,this.rebindTextures=Ce,this.setupRenderTarget=vt,this.updateRenderTargetMipmap=ft,this.updateMultisampleRenderTarget=gn,this.setupDepthRenderbuffer=$e,this.setupFrameBufferTexture=de,this.useMultisampledRTT=He}function yw(t,e){function n(i,r=Oi){let s;const o=qe.getTransfer(r);if(i===xi)return t.UNSIGNED_BYTE;if(i===Td)return t.UNSIGNED_SHORT_4_4_4_4;if(i===wd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===d_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===c_)return t.BYTE;if(i===f_)return t.SHORT;if(i===Uo)return t.UNSIGNED_SHORT;if(i===Ed)return t.INT;if(i===br)return t.UNSIGNED_INT;if(i===fi)return t.FLOAT;if(i===zo)return t.HALF_FLOAT;if(i===h_)return t.ALPHA;if(i===p_)return t.RGB;if(i===kn)return t.RGBA;if(i===m_)return t.LUMINANCE;if(i===g_)return t.LUMINANCE_ALPHA;if(i===gs)return t.DEPTH_COMPONENT;if(i===Ps)return t.DEPTH_STENCIL;if(i===__)return t.RED;if(i===Ad)return t.RED_INTEGER;if(i===v_)return t.RG;if(i===Cd)return t.RG_INTEGER;if(i===Rd)return t.RGBA_INTEGER;if(i===Wa||i===Xa||i===ja||i===Ya)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Wa)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Xa)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ja)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ya)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Wa)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Xa)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ja)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ya)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Qc||i===Jc||i===ef||i===tf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Qc)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Jc)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ef)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===tf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===nf||i===rf||i===sf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===nf||i===rf)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===sf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===of||i===af||i===lf||i===uf||i===cf||i===ff||i===df||i===hf||i===pf||i===mf||i===gf||i===_f||i===vf||i===xf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===of)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===af)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===lf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===uf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===cf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ff)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===df)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===hf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===pf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===mf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===gf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===_f)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===vf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===xf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===qa||i===yf||i===Sf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===qa)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===yf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Sf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===x_||i===Mf||i===Ef||i===Tf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===qa)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Mf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ef)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Tf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===bs?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const Sw=`
void main() {
